...
<table id="tbl" width="100%">
  ...
  <tr text-align="center">
    ...
    <td>
     <a href="index.php?p=d_pimpinan_tools&id=<?php echo $id_pimpinan; ?>&aksi=detail" title="Rincian Profile">Detail</a>
     <a href="index.php?p=d_pimpinan_tools&id=<?php echo $id_pimpinan; ?>&aksi=edit" title="Ubah Data pimpinan">Edit</a>
